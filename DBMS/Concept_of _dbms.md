...
8. Datetime Functions (Complete List)
8.1 Current Date & Time
sql
Copy code
SELECT GETDATE();        -- 2025-01-01 10:20:30
SELECT SYSDATETIME();
...
sql
Copy code
SELECT ISDATE('2024-15-20');  -- 0 invalid
9. Conversion Functions
CAST()
sql
Copy code
SELECT CAST('2024-02-05' AS DATE);
SELECT CAST(12.56 AS INT);   -- 12
CONVERT()
sql
Copy code
...
Copy code
SELECT ABS(-100);        -- 100
SELECT CEILING(12.3);     -- 13
SELECT FLOOR(12.9);       -- 12
SELECT SQRT(81);          -- 9
SELECT POWER(2, 4);       -- 16
SELECT ROUND(10.5678, 2); -- 10.57
